							...
							<table class="table">
								...
								<tbody>
									...
									<tr class="danger">
										...
										<td><a
											href="DoctorDetailsDoctor.jsp?dr=<%=resultSet.getString(10)%>"
											onclick="return confirm_alert(this);"><%=resultSet.getString(10)%></a></td>
										
										<td><a
											href="PatientsDetailsDoctor.jsp?id=<%=resultSet.getString("id")%>"
											onclick="return confirm_alert(this);">view</a></td>
										
										<td><a
											href="removePatient.jsp?id=<%=resultSet.getString("id")%>"
