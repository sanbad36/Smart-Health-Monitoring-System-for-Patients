...
<div class="login-page">
  <div class="form">
    <h1 style="color:black; text-shadow: 0.5px 0.5px 0.5px blue;"><center>SMART ICU</center></h1><br><br>
    <form class="login-form" action="loginAdmin.jsp">
      <button>Admin Login</button>
    </form>
    <br><br>
    <form class="login-form" action="loginDoctor.jsp">
      <button>Doctor Login</button>
    </form>
    <br><br>
    <form class="login-form" action="loginSupervisor.jsp">
