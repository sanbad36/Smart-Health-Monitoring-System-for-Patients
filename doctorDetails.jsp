					...
					<div class="panel panel-widget">
						<div class="row">
							...
							<%
								...
								ResultSet rs = st.executeQuery("select * from doctor where id = '" + id1 + "'");
							...
							<img style="margin-top: 30px;; width: 200px; height: 200px"
								src="http://localhost:8080/ICU/imageDoctor.jsp?id=<%=rs.getString("id")%>"">
							...
							<br>
							<h3>
								<b>Specialization : </b><%=rs.getString(6)%></h3>
							<br>
							<h3>
								<b>Date Of Visit : </b><%=rs.getString(7)%></h3>
							<br>
							<h3>
								<b>Hospital Name : </b><%=rs.getString(8)%></h3>
							<br>
							<h3>
							...
							<h3>
								<b><a href="removeDoctor.jsp?id=<%=rs.getString(1)%>"
