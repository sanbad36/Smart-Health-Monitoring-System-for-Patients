				...
				<div class="row">
					...
					<div class="panel panel-widget">
						<div class="row">
							...
							<br>
							<h4>
								<b>doctor : </b><%=rs.getString(10)%></h4><br>
							...
							<Div>
														<center><h2>Relative Information	</h2><center>
							...
							%>
							<a href="<%=Path + file.getName()%>" target="_blank"><br>
								<%=file.getName()%><br> </a>
							...
							%>
							 ...
							 <a href="removePatient.jsp?id=<%=rs.getString(1)%>"
							...
							&nbsp;<a href="editPatient.jsp?id=<%=rs.getString(1)%>"
								...
								<a href="UploadDocument.jsp?kit=<%=rs.getString(1)%>"
								onclick="return confirm_alert(this);"><button>UploadDocument</button></a>
