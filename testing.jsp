...
if(rs1.next()) {
map = new HashMap<Object,Object>(); map.put("x", 5); map.put("y", Integer.parseInt(rs1.getString(1))); map.put("indexLabel", "tempSensor");list.add(map);
map = new HashMap<Object,Object>(); map.put("x", 10); map.put("y", Integer.parseInt(rs1.getString(2))); map.put("indexLabel", "	vibrationSensor"); list.add(map);
map = new HashMap<Object,Object>(); map.put("x", 15); map.put("y", Integer.parseInt(rs1.getString(3))); map.put("indexLabel", "pulseSensor");list.add(map);
map = new HashMap<Object,Object>(); map.put("x", 20); map.put("y", Integer.parseInt(rs1.getString(4))); map.put("indexLabel", "spo2Sensor");list.add(map);
