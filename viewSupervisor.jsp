							...
							<table class="table">
								...
								<tbody>
									...
									<tr class="danger">
										...
										<td><%=resultSet.getString("supervisorname")%></td>
										...
										<td><a
											href="SupervisorDetails.jsp?id=<%=resultSet.getString("id")%>"
											onclick="return confirm_alert(this);">view</a></td>
										
										<td><a
											href="removesupervisor.jsp?id=<%=resultSet.getString("id")%>"
