...
<%
	String patientid= request.getParameter("kit");
	%>
							...
							<div class="forms">
								<div class="form-grids widget-shadow"
									...
									<div class="form-title">
										<h4>Add Patient Description</h4>
									</div>
									<div class="form-body">

										<form method="post" action="PatientRecord">
											
											
												<Div>
													<Lable class="col-sm-2 form-control-label"> Patient Id:</Lable>
													<div class="col-sm-10"><input type="text" class="form-control"
														name="kitTxt" value=<%=patientid %> readonly="readonly" required>
													</div>
												</div>
												<br>
												<br>
												<br>
												<Div>
													<Lable class="col-sm-2 form-control-label">Prescription:</Lable>
													<div class="col-sm-10"><textarea rows="4" cols="50" type="text" class="form-control"
														name="prescriptionTxt" required></textarea>
													</div>
												</div>
												<br>
												...
												<br>
												<Div>
													<Lable class="col-sm-2 form-control-label">NextVisit:</Lable>
													<div class="col-sm-10"><input type="date" class="form-control"
														name="nextvisitTxt" required>
													</div>
												</div>
												<br>
												<br>
												...
												<Div>
													<Lable class="col-sm-2 form-control-label">Decription:</Lable>
													<div class="col-sm-10"><textarea rows="4" cols="50" type="text" class="form-control"
														name="decriptionTxt"  required></textarea>
													</div>
												</div>
												<br>
												<br>
