							...
							<div class="forms">
								<div class="form-grids widget-shadow"
									...
									<div class="form-title">
										<h4>Add Supervisor details</h4>
									</div>
									<div class="form-body">



										<form method="post" action="SupervisorAdd"
											enctype="multipart/form-data">

											<Div>
												<Lable class="col-sm-2 form-control-label">Supervisor
												Name:</Lable>
												<div class="col-sm-10">
											...
											<Div>
												...
												<div class="col-sm-10">
													<input type="text" onkeypress="return isNumberKey(event)"
														placeholder="Contact" minlength="10" maxlength="10"
														class="form-control" name="ContactTxt">
												</div>
											</Div>
											<br> <br> <br>
											<Div>
												...
												<div class="col-sm-10">
													<input type="password" class="form-control"
														placeholder="Password" name="passwordTxt">
												</div>
											</Div>
											<br> <br> <br>
											<Div>
												<Lable class="col-sm-2 form-control-label">Qualification:</Lable>
												<div class="col-sm-10">
													<input type="text" class="form-control"
														placeholder="Qualification" name="qualificationTxt">
												</div>
											</Div>
											<br> <br> <br>
											<Div>
												<Lable class="col-sm-2 form-control-label">Shift:</Lable>
												<div class="col-sm-10">
													<input type="text" class="form-control" name="shiftTxt"
														placeholder="Shift">
												</div>
											</Div>
											<br> <br> <br>
