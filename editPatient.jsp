					...
					<div class="panel panel-widget">
						<div class="row">
							...
							<img style="margin-top: 30px;; width: 200px; height: 200px"
								src="http://localhost:8080/ICU/imagePatient.jsp?id=<%=rs.getString("id")%>"><br>


							<h3>
								<br><b>ID: </b><%=rs.getString(1)%></h3>
							<br>
							<form method="post" action="PatientsEdit">
											<table border="0">
											<tr>
												...
												<tr>
													<td>Icuward:</td>
													<td><input type="text" class="form-control"
														name="emailTxt"  value=<%=rs.getString(3)%>></td>
												</tr>
												...
												<tr>
													...
													<td><input type="text"
														...
														maxlength="10" class="form-control" name="ContactTxt"
														value=<%=rs.getString(4)%>></td>
												</tr>
												<tr>
													<td>Bedno:</td>
													<td><input type="text" class="form-control"
														name="passwordTxt"  value=<%=rs.getString(5)%>></td>
												</tr>

												<tr>
													<td>Address:</td>
													<td><input type="text" class="form-control"
														name="addressTxt" value=<%=rs.getString(6)%>></td>
												</tr>
												<tr>
													<td>Disease:</td>
													<td><input type="text" class="form-control"
														name="diseaseTxt" value=<%=rs.getString(7)%>></td>
												</tr>
												...
												<tr>
													<td>Gender:</td>
													<td><select name='genderTxt' class="form-control" value=<%=rs.getString(9)%>>
												...
												<tr>
													<td>Doctor:</td>
													<td><select name='doctorTxt' class="form-control" value=<%=rs.getString(10)%>>
								...
								addedDate=dtf1.format(now1);
												...
												<tr>
													<td>Status:</td>
													<td><select name='statusTxt' class="form-control" value=<%=rs.getString(23)%>>
															<option><%=rs.getString(23)%></option>
															<option>Discharge On <%=addedDate %></option>
