					...
					<div class="panel panel-widget">
						<div class="row">
							...
							<%
								...
								ResultSet rs = st.executeQuery("select * from supervisor where id = '" + id1 + "'");
							...
							<img style="margin-top: 30px; width: 200px; height: 200px"
								src="http://localhost:8080/ICU/imageSupervisor.jsp?id=<%=rs.getString("id")%>"">
							...
							<br>
							<h3>
								<b>Supervisor Name : </b><%=rs.getString(2)%></h3>
							<br>
							<h3>
								<b>Email: </b><%=rs.getString(3)%></h3>
							<br>
							<h3>
								<b>Contact: </b><%=rs.getString(4)%></h3>
							<br>
							<h3>
								<b>Password: </b><%=rs.getString(5)%></h3>
							<br>
							<h3>
								<b>Qualification: </b><%=rs.getString(6)%></h3>
							<br>
							<h3>
								<b>Shift: </b><%=rs.getString(7)%></h3>
							<br>
							<h3>
								<b>Gender: </b><%=rs.getString(8)%></h3>
							<br>


							<h3>
								<b><a href="removesupervisor.jsp?id=<%=rs.getString(1)%>"
