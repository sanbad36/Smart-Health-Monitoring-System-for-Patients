				...
				<nav
					...
					<div class="scrollbar scrollbar1">
						<ul class="nav" id="side-menu">
							<li><a href="welcomeAdmin.jsp" class="active"><i
									class="fa fa-home nav_icon"></i>HOME</a></li>

							<li><a href="viewSupervisor.jsp"><i
									class="fa fa-book nav_icon"></i>view ICU Supervisor </a>
							<li><a href="addSupervisor.jsp"><i
									class="fa fa-check-square-o nav_icon"></i>Add ICU Supervisor</a></li>

							<li><a href="viewDoctor.jsp"><i
									class="fa fa-book nav_icon"></i>view Doctor</a>
							<li><a href="addDoctor.jsp"><i
									class="fa fa-check-square-o nav_icon"></i>Add Doctor</a></li>
							...
							<div class="forms">
								<div class="form-grids widget-shadow"
									...
									<div class="form-title">
										<h4>Add Managers details</h4>
									</div>
									<div class="form-body">



										<form method="post" action="DoctorAdd"
											enctype="multipart/form-data">
											<table border="0">
												<Div>
													<Lable class="col-sm-2 form-control-label">Doctor
													Name:</Lable>
													<div class="col-sm-10">
												...
												<br>
												<Div>
													<Lable class="col-sm-2 form-control-label">Email:</Lable>
													<div class="col-sm-10">
												...
												<Div>
													...
													<div class="col-sm-10">
														<input type="text" onkeypress="return isNumberKey(event)"
															...
															name="ContactTxt" placeholder="Contact" required>
												...
												<br>
												<Div>
													<Lable class="col-sm-2 form-control-label">Password:</Lable>
													<div class="col-sm-10">
														<input type="password" class="form-control"
															placeholder="Password" name="passwordTxt" required>
													</div>
												</div>
												<br>
												<br>
												<br>
												<Div>
													<Lable class="col-sm-2 form-control-label">Specialization:</Lable>


													<div class="col-sm-10">
														<input type="text" class="form-control"
															placeholder="Specialization" name="specializationTxt"
															required>
													</div>
												</div>
												<br>
												...
												<br>
												<Div>
													<Lable class="col-sm-2 form-control-label">DateOfVisit:</Lable>

													<div class="col-sm-10">
														<input type="date" class="form-control"
															placeholder="DateOfVisit" name="visitdateTxt" required>
													</div>
												</div>
												<br>
												<br>
												...
												<Div>
													<Lable class="col-sm-2 form-control-label">Hospital
													Name: 
												</div>
												<div class="col-sm-10">
													<input type="text" class="form-control" name="hospitalTxt"
												...
												<div class="col-sm-10" >
													<div class="radio-group">
														<input type="radio" id="option-one" name="genderTxt" ><label
															for="option-one" value="Male">Male</label><input
															type="radio" id="option-two" name="genderTxt"
															value="Female"><label for="option-two"
															value="Male">Female</label><input type="radio"
															id="option-three" name="genderTxt" value="Other"><label
															for="option-three">Other</label>
													</div>
												</div>
											</Div>
												<br>
											...
											<Div>
												<td colspan="2"><input type="submit" value="Save" class="btn btn-info">
											</div>
											</table>
										</form>
									</div>
