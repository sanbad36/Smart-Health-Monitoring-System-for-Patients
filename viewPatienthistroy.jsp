			...
			<div class="main-page">
				...
				<div class="row">
					...
					<div class="panel panel-widget">
						...
						String kitid = Id.getKit();
						if(kitid.equals(null)){
							kitid=request.getParameter("kit");
						}
						%>
							<h4>Patient Id: <%=kitid %></h4><br>
							<table class="table">
								<thead>
									<tr class="warning">
								...
								<tbody>
									...
									<%
										try {
											...
											resultSet = statement.executeQuery("select * from paitientrecord where patientid='"+kitid+"'");
